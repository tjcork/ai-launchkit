...
Originally forked from [n8n-installer](https://github.com/kossakovsky/n8n-installer), AI CoreKit has evolved into a complete AI development platform designed for privacy, performance, and ease of use.
