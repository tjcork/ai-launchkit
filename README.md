...
| [**Gitea**](services/workflow-automation/gitea) | `gitea` | Lightweight, self-hosted DevOps platform and Git service providing source code management, issue tracking, and CI/CD capabilities. [[↗](https://github.com/go-gitea/gitea)] |
...
| Service | Name | Description |
| --- | --- | ------ |
| [**Homepage**](services/user-interfaces/homepage) | `homepage` | Modern, customizable dashboard providing a centralized overview and quick access to all hosted services and Docker integrations. [[↗](https://github.com/gethomepage/homepage)] |
...
| [**Open WebUI**](services/user-interfaces/open-webui) | `open-webui` | Feature-rich, self-hosted web interface (ChatGPT alternative) for interacting with local Large Language Models. [[↗](https://github.com/open-webui/open-webui)] |
| [**Postiz**](services/user-interfaces/postiz) | `postiz` | Open-source social media scheduling and publishing platform with analytics and multi-account support. [[↗](https://github.com/gitroomhq/postiz-app)] |
...
| Service | Name | Description |
| --- | --- | ------ |
| [**Jitsi Meet**](services/video-conferencing/jitsi) | `jitsi` | Secure, open-source video conferencing platform supporting screen sharing, team calls, and webinar hosting (Requires UDP port 10000). [[↗](https://github.com/jitsi/jitsi-meet)] |
...
| Service | Name | Description |
| --- | --- | ------ |
| [**Airbyte**](services/business-productivity/airbyte) | `airbyte` | Advanced data integration platform capable of syncing data from over 600 sources (Google Ads, Meta, TikTok, GA4) to data warehouses. Ideal for use with Metabase. [[↗](https://github.com/airbytehq/airbyte)] |
...
| [**Outline**](services/business-productivity/outline) | `outline` | Team knowledge base and documentation platform serving as a Notion alternative with a modern, real-time editor. [[↗](https://github.com/outline/outline)] |
...
| Service | Name | Description |
| --- | --- | ------ |
| [**ComfyUI**](services/ai-content-generation/comfyui) | `comfyui` | Node-based user interface for Stable Diffusion, enabling complex image generation workflows, AI art creation, and photo editing. [[↗](https://github.com/comfyanonymous/ComfyUI)] |
...
| Service | Name | Description |
| --- | --- | ------ |
| [**bolt.diy**](services/ai-powered-development/bolt) | `bolt` | AI-powered web development tool for rapid prototyping, creating MVPs, and assisting in learning to code. [[↗](https://github.com/stackblitz-labs/bolt.diy)] |
| [**OpenUI**](services/ai-powered-development/openui) | `openui` | Experimental AI frontend and UI generator for creating design systems, component libraries, and mockups. [[↗](https://github.com/wandb/openui)] |
...
| [**Browser Automation Suite**](services/ai-agents/browser-suite) | `browser-suite` | Comprehensive browser automation suite combining Browserless, Skyvern, and Browser-use for web scraping, form filling, and automated testing. [[↗](https://github.com/browser-use/browser-use)] |
| [**Dify**](services/ai-agents/dify) | `dify` | LLM application development platform designed for building AI agents, chatbots, and automating workflows. [[↗](https://github.com/langgenius/dify)] |
| [**Flowise**](services/ai-agents/flowise) | `flowise` | Drag-and-drop AI agent builder for creating chatbots, customer support assistants, and complex AI workflows. [[↗](https://github.com/FlowiseAI/Flowise)] |
| [**Letta**](services/ai-agents/letta) | `letta` | Agent Server and SDK enabling the creation of persistent AI assistants with advanced memory management capabilities. [[↗](https://github.com/letta-ai/letta)] |
| [**LiveKit**](services/ai-agents/livekit) | `livekit` | Real-time voice/video WebRTC infrastructure for building AI voice assistants and conversational AI bots. Requires UDP ports 50000-50100. [[↗](https://github.com/livekit/livekit)] |
| [**Vexa**](services/ai-agents/vexa) | `vexa` | Real-time meeting transcription API supporting 99 languages, offering live transcription for Google Meet & Teams with speaker identification. [[↗](https://github.com/Vexa-ai/vexa)] |
...
| Service | Name | Description |
| --- | --- | ------ |
| [**Qdrant**](services/rag-systems/qdrant) | `qdrant` | High-performance vector database optimized for semantic search, recommendation engines, and RAG storage. [[↗](https://github.com/qdrant/qdrant)] |
...
| [**Weaviate**](services/rag-systems/weaviate) | `weaviate` | Cloud-native vector database with API key authentication, supporting hybrid search, multi-modal data, and GraphQL APIs. [[↗](https://github.com/weaviate/weaviate)] |
...
| Service | Name | Description |
| --- | --- | ------ |
| [**LibreTranslate**](services/speech-language-text/libretranslate) | `libretranslate` | Self-hosted, privacy-focused translation API supporting over 50 languages for text and document translation. [[↗](https://github.com/LibreTranslate/LibreTranslate)] |
...
| [**Scriberr**](services/speech-language-text/scriberr) | `scriberr` | AI-powered audio transcription tool featuring speaker diarization, ideal for creating meeting transcripts, processing podcasts, and analyzing call recordings. [[↗](https://github.com/rishikanthc/Scriberr)] |
| [**Speech Stack**](services/speech-language-text/speech) | `speech` | CPU-optimized speech stack combining Whisper ASR and OpenedAI TTS, suitable for building voice assistants, generating audiobooks, and audio notifications. [[↗](https://github.com/matatonic/openedai-speech)] |
| [**TTS Chatterbox**](services/speech-language-text/tts-chatterbox) | `tts-chatterbox` | State-of-the-art Text-to-Speech system serving as a high-quality alternative to ElevenLabs, providing AI voices with rich emotional expression. [[↗](https://github.com/resemble-ai/chatterbox)] |
...
| Service | Name | Description |
| --- | --- | ------ |
| [**LightRAG**](services/knowledge-graphs/lightrag) | `lightrag` | Graph-based Retrieval-Augmented Generation (RAG) system specializing in entity extraction and automatic knowledge graph creation. [[↗](https://github.com/HKUDS/LightRAG)] |
| [**Neo4j**](services/knowledge-graphs/neo4j) | `neo4j` | High-performance graph database optimized for knowledge graphs, relationship mapping, and fraud detection. [[↗](https://github.com/neo4j/neo4j)] |
...
| Service | Name | Description |
| --- | --- | ------ |
| [**Supabase**](services/data-infrastructure/supabase) | `supabase` | Open-source Backend-as-a-Service (BaaS) providing Database, Authentication, Realtime subscriptions, Storage, and Edge Functions. [[↗](https://github.com/supabase/supabase)] |
| [**MySQL Database**](services/data-infrastructure/mysql) | `mysql` | Shared MySQL database instance powering services like Leantime and Mautic. [[↗](https://hub.docker.com/_/mysql)] |
| [**PostgreSQL Database**](services/data-infrastructure/postgres) | `postgres` | Shared PostgreSQL database instance serving as the backend for n8n, Flowise, and other data-intensive applications. [[↗](https://hub.docker.com/_/postgres)] |
| [**Redis Cache**](services/data-infrastructure/redis) | `redis` | Shared Redis instance providing caching and message brokering for services like n8n. [[↗](https://hub.docker.com/_/redis)] |
...
| Service | Name | Description |
| --- | --- | ------ |
| [**Caddy Reverse Proxy**](services/system-management/caddy) | `caddy` | Advanced Reverse Proxy and Web Server providing automatic SSL termination and routing for all hosted services. [[↗](https://caddyserver.com/)] |
| [**Cloudflare Web Tunnel**](services/system-management/web-tunnel) | `web-tunnel` | Cloudflare Tunnel configuration for securely exposing local web services to the internet without opening public ports. [[↗](https://github.com/cloudflare/cloudflared)] |
...
| [**Vaultwarden**](services/system-management/vaultwarden) | `vaultwarden` | Lightweight, self-hosted password manager compatible with Bitwarden clients, enabling secure credential management and team sharing. [[↗](https://github.com/dani-garcia/vaultwarden)] |
...
| Service | Name | Description |
| --- | --- | ------ |
| [**DocuSeal**](services/ai-support-tools/docuseal) | `docuseal` | Open-source e-signature platform serving as a DocuSign alternative for document signing and managing contract workflows. [[↗](https://github.com/docusealco/docuseal)] |
| [**Gotenberg**](services/ai-support-tools/gotenberg) | `gotenberg` | Powerful document conversion API for converting HTML, Markdown, and Office documents to PDF, as well as merging PDF files. [[↗](https://github.com/gotenberg/gotenberg)] |
| [**Ollama**](services/ai-support-tools/ollama) | `ollama` | Local Large Language Model (LLM) runner enabling the execution of models like Llama, Mistral, and Phi locally with an API-compatible interface. [[↗](https://github.com/ollama/ollama)] |
| [**Stirling-PDF**](services/ai-support-tools/stirling-pdf) | `stirling-pdf` | Comprehensive PDF manipulation tool offering over 100 features including merging, splitting, compressing, OCR, and signing documents. [[↗](https://github.com/Stirling-Tools/Stirling-PDF)] |
...
| Service | Name | Description |
| --- | --- | ------ |
| [**AI Security Suite - LLM Guard + Presidio**](services/ai-security-compliance/ai-security) | `ai-security` | Comprehensive AI security suite combining LLM Guard and Presidio for AI safety and GDPR-compliance, preventing prompt injections, filtering toxicity, and removing PII. [[↗](https://github.com/protectai/llm-guard)] |
...
| Service | Name | Description |
| --- | --- | ------ |
| [**Python Runner**](services/python/python-runner) | `python-runner` | Execution environment for running custom Python scripts and workflows, designed to integrate seamlessly with n8n. [[↗](https://github.com/n8n-io/n8n)] |
